...
void BasicGraspingPerception::cloudCallback(const pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr& cloud)
{
  // be lazy
  if (!find_objects_)
    return;
...
void BasicGraspingPerception::executeCallback(const grasping_msgs::FindGraspableObjectsGoalConstPtr& goal)
{
